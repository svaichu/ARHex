...
def arhex_joint_positions_publisher():
	...
	pub3 = rospy.Publisher('/arhex/joint1_position_controller/command', Float64, queue_size=10)
	pub4 = rospy.Publisher('/arhex/joint2_position_controller/command', Float64, queue_size=10)
	pub5 = rospy.Publisher('/arhex/joint1_position_controller/command', Float64, queue_size=10)
	pub6 = rospy.Publisher('/arhex/joint2_position_controller/command', Float64, queue_size=10)
  rate = rospy.Rate(100)
